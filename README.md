...
### WLA Basic Page Info Checker bookmarklet
  ...
  * Screenshot  
  ...
  ![image of WLA Basic Page Info Checker result](screenshots/WLABasicPageInfoChecker.png)

  <p align=center>Image of Wikipedia WLA Basic Page Info Checker result</p>
